...
case "user":
	...
	echo "/* QUERY: $query */";
	$fields_array = array( 'name', 'ip', 'password', 'password2', 'type', 'access_option' );
	break;
}
...
?>
{'metaData': { totalProperty: 'results', root: 'rows', id: 'ID', fields: [ <?php echo implode( ",", $field_definition_array );?> ]},'results': <?php echo $num_results;?>, 'rows': <?php echo json_encode( $results_row_array ); ?>}
