  ...
  */
  public function debug() {
	...
	public function result_array() {
		$result = array();
		for($i=0;$i<sizeof($this -> m3uFile_SongLocations);$i++)
		{
			$result[] = array(
				"path"=>$this -> m3uFile_SongLocations[$i],
				"title"=>$this -> m3uFile_SongTitles[$i],
				"length"=>$this -> m3uFile_SongLengths[$i]);
		}
		return $result;
	}
}
...
//echo $m3uParser -> prettyOutput("songTitle", "asc", true, "100%", 5, 5, 1, "center", "style=\"border: 1px solid #000;border-collapse: collapse;\"");
