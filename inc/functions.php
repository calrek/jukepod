...
function json_umlaut( $var ) {
	if ( is_array( $var ) ) {
		...
		/*$var=preg_replace("/䯢,"&auml;",$var);
		$var=preg_replace("/į","&Auml;",$var);
		$var=preg_replace("/�/","&ouml;",$var);
		$var=preg_replace("/֯","&Ouml;",$var);
		$var=preg_replace("/�/","&uuml;",$var);
		$var=preg_replace("/ܯ","&Uuml;",$var);
		$var=preg_replace("/߯","&szlig;",$var);*/
...
function json_umlaut_reverse( $var ) {
	if ( is_array( $var ) ) {
		...
		/*$var=str_replace("&auml;","䢬$var);
		$var=str_replace("&Auml;","Ģ,$var);
		$var=str_replace("&ouml;","�",$var);
		$var=str_replace("&Ouml;","֢,$var);
		$var=str_replace("&uuml;","�",$var);
		$var=str_replace("&Uuml;","ܢ,$var);
		$var=str_replace("&szlig;","ߢ,$var);*/
