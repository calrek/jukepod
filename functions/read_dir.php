...
<script type="text/javascript" src="javascript/progress-bar.js"></script>
...
<body class="x-border-layout-ct">
	<script>
	var dir_id = <? if($_GET["id"]) echo $_GET["id"]; else echo "0"; ?>;
	var scan_method = '<? if($_GET["scan_method"]) echo $_GET["scan_method"]; else echo ""; ?>';
	var reset_db = <? if($_GET["reset_db"]) echo $_GET["reset_db"]; else echo "0"; ?>;
</script>
	<div class="read_dir">
		<div class="container">
