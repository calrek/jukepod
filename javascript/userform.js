			...
			items: [
					new Ext.form.ComboBox({
						...
						store:new Ext.data.JsonStore({
							...
							root: 'rows',
							baseParams: {tab: form_name,no_assign: 1},
							fields: ['ID', 'name'],
							autoLoad: true,
							listeners: {
								load: function() { 
													...
													items: [{
															...
															},
															{
																	...
																	items: [
																			...
																			{inputValue: "1", id: 'permission_has_access', boxLabel: '<?php echo lang("access_jukebox",1);?>', name: 'permission_has_access'},
																			{inputValue: "1", id: 'permission_useradmin', boxLabel: '<?php echo lang("administrate_user",1);?>', name: 'permission_useradmin'},
																			{inputValue: "1", id: 'permission_read_files', boxLabel: '<?php echo lang("read_files",1);?>', name: 'permission_read_files'},
																			{inputValue: "1", id: 'permission_see_all_playlists', boxLabel: '<?php echo lang("see_all_playlists",1);?>', name: 'permission_see_all_playlists'},
																			{inputValue: "1", id: 'permission_edit_own_playlists', boxLabel: '<?php echo lang("edit_own_playlists",1);?>', name: 'permission_edit_own_playlists'},
																			{inputValue: "1", id: 'permission_edit_all_playlists', boxLabel: '<?php echo lang("edit_all_playlists",1);?>', name: 'permission_edit_all_playlists'},
																			{inputValue: "1", id: 'permission_edit_tags', boxLabel: '<?php echo lang("edit_tags",1);?>', name: 'permission_edit_tags'},
																			{inputValue: "1", id: 'permission_download', boxLabel: '<?php echo lang("download_files",1);?>', name: 'permission_download'},
																			{inputValue: "1", id: 'permission_lyrics', boxLabel: '<?php echo lang("fetch_lyrics",1);?>', name: 'permission_lyrics'},
																			{inputValue: "1", id: 'permission_youtube', boxLabel: '<?php echo lang("fetch_youtube_videos",1);?>', name: 'permission_youtube'}
																	]
															}		
															]}                                                                                                                       
													]
